      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          <div class="pull-right">
            <a href="<?php echo base_url() ?>Laporan" class="btn btn-success"><i class="mdi mid-plus-circle mr-2 fa fa-print"></i> Cetal Laporan</a>
            ...
            <a data-toggle="modal" data-target="#TambahModal" class="btn btn-primary"><i class="mdi mid-plus-circle mr-2 fa fa-plus"></i> Tambah Pelajar dengan Modal</a>
          </div>
          </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $data['email'] ?>@niomic.com</td>
                  ...
                  data-email="<?php echo $data['email'] ?>"><i class="fa fa-edit"></i></a></span>
                    <span data-toggle="tooltip" data-original-title="Hapus Data" style="font-size:10;"><a class="btn btn-danger" href="<?php echo base_url()?>Niomic/delete/<?php echo $data['nis']; ?>"onclick="return confirm('Yakin hapus data?');"> <i class="fa fa-trash-o"></i></a></span></td>
                </tr>
                <?php } ?>
                </tfoot>
              </table>
